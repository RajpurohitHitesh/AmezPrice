    ...
    <main class="container">
        <div class="card about-page">
            ...
            <section id="who-we-are">
                <h2>1. Who We Are</h2>
                <p>AmezPrice is a leading price tracking and comparison platform designed exclusively for Indian consumers. Based in Bengaluru, Karnataka, we help shoppers make informed purchase decisions by tracking product prices on Amazon India and Flipkart. Our user-friendly website and Telegram bot empower users to monitor price trends, receive notifications, and discover the best deals.</p>
            </section>
            ...
            <section id="contact">
                ...
                <p>Address: AmezPrice, 123 Tech Park, Bengaluru, Karnataka, India</p>
            </section>
        </div>
    </main>
