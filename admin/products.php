...
// Debug logging
error_log("Session data on admin products: " . print_r($_SESSION, true));
...
<head>
    ...
    <title>Products - AmezPrice</title>
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
                    ...
                    <tbody>
                        <?php foreach ($products as $product): ?>
                            <tr>
                                ...
                                <td><?php echo $product['tracking_users']; ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <div class="pagination" style="text-align: center; margin-top: 24px;">
                <?php if ($page > 1): ?>
                    <a href="/admin/products.php?page=<?php echo $page - 1; ?>" class="btn btn-secondary">Prev</a>
                <?php endif; ?>
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a href="/admin/products.php?page=<?php echo $i; ?>" class="btn <?php echo $i === $page ? 'btn-primary' : 'btn-secondary'; ?>"><?php echo $i; ?></a>
                <?php endfor; ?>
                <?php if ($page < $totalPages): ?>
                    <a href="/admin/products.php?page=<?php echo $page + 1; ?>" class="btn btn-secondary">Next</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
