...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_profile') {
        ...
        if ($email !== $user['email'] && !$otp) {
            ...
            file_put_contents('USER_LOG_PATH', "[" . date('Y-m-d H:i:s') . "] OTP sent to $email for profile update\n", FILE_APPEND);
        ...
        file_put_contents('USER_LOG_PATH', "[" . date('Y-m-d H:i:s') . "] Profile updated for user ID $userId\n", FILE_APPEND);
    ...
    if ($action === 'update_password') {
        ...
        if (!$otp) {
            ...
            file_put_contents('USER_LOG_PATH', "[" . date('Y-m-d H:i:s') . "] OTP sent to {$user['email']} for password change\n", FILE_APPEND);
