...
<footer class="footer">
    <div class="footer-content">
        ...
        <div class="footer-section footer-right">
            <h3>PricePulse Bots</h3>
            <div class="footer-bots">
                <a href="https://t.me/AmezPriceBot" class="btn bot-btn" target="_blank" aria-label="AmezPrice Bot"><i class="fas fa-robot"></i> AmezPrice Bot</a>
                <a href="https://t.me/AmezPriceHotDealsBot" class="btn bot-btn" target="_blank" aria-label="HotDeals Bot"><i class="fas fa-fire"></i> HotDeals Bot</a>
            </div>
            ...
            <div class="footer-channels">
                ...
                <a href="<?php echo htmlspecialchars($telegramConfig['channels']['hotdeals']); ?>" class="btn channel-btn" target="_blank" aria-label="HotDeals Channel"><i class="fab fa-telegram"></i> HotDeals</a>
            </div>
        </div>
    </div>
